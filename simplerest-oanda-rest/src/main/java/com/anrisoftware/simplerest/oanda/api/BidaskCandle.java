 ...
 * @since 1.0
 */
public interface BidaskCandle extends Candle {

    BigDecimal getOpenBid();

    BigDecimal getOpenAsk();

    BigDecimal getHighBid();

    BigDecimal getHighAsk();

    BigDecimal getLowBid();

    BigDecimal getLowAsk();

    BigDecimal getCloseBid();

    BigDecimal getCloseAsk();
