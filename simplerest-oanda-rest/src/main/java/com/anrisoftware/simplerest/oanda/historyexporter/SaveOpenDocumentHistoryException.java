...
public class SaveOpenDocumentHistoryException extends HistoryExportException {

    public SaveOpenDocumentHistoryException(IOException e, File file) {
        super("Save open document spreadsheet error", e);
