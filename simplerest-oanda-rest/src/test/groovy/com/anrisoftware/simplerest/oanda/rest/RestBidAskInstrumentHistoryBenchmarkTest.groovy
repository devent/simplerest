...
@Slf4j
@CompileStatic
class RestBidAskInstrumentHistoryBenchmarkTest {

    OandaAccount account

    @Bench(runs=5)
    void "retrieve all instruments"() {
        def history = dep.historyFactory.create(account, dep.instrumentsUtil.eurCad)
    ...
    void "benchmark RestBidAskInstrumentHistory"() {
        ...
        benchmark.add RestBidAskInstrumentHistoryBenchmarkTest
