...
/**
 * Microbenchmark {@link RestBidAskInstrumentHistory}.
 *
...
@Slf4j
@CompileStatic
class RestBidAskInstrumentHistoryPoolingBenchmarkTest {
    ...
    void "retrieve all instruments"() {
        def history = dep.historyFactory.create(account, dep.instrumentsUtil.eurCad, client)
    ...
    @Test
    void "benchmark RestBidAskInstrumentHistory"() {
        Benchmark benchmark = new Benchmark()
        benchmark.add RestBidAskInstrumentHistoryPoolingBenchmarkTest
