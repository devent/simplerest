...
@Slf4j
@CompileStatic
class RestInstrumentsBenchmarkTest {

    OandaAccount account

    @Bench(runs=5)
    void "retrieve all instruments"() {
        def instruments = dep.instrumentsFactory.create(account, dep.instrumentsFilterFactory.create())
        instruments.call()
    }
    ...
    void "benchmark calculate analysis of fractals"() {
        ...
        benchmark.add RestInstrumentsBenchmarkTest
